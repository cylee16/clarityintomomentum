...
(function() {
  ...
  style.textContent = [
    ...
    '.cim-kit-card .cim-btn{display:block;width:100%;background:#2D5F6F;color:#FFFFFF;font-weight:800;font-size:12.5px;padding:10px;border-radius:7px;border:none;cursor:pointer;text-align:center;text-decoration:none;font-family:inherit;transition:background .2s;}',
    '.cim-kit-card .cim-btn:hover{background:#24505E;}',
    ...
    '.cim-kit-card .cim-mobile-sub{display:block;font-size:11px;color:#E7DDD6;font-weight:500;margin-top:2px;grid-column:1;}',
